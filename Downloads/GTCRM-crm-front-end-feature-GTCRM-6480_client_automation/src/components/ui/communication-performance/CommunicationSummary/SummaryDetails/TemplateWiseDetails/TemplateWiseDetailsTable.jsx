...
import {
  ...
  templateWiseEmailDetailsTableHeader,
  templateWiseSMSDetailsTableHeader,
  templateWiseWhatsappDetailsTableHeader,
...
const TemplateWiseDetailsTable = ({ tabValue }) => {
            ...
            <>
              {tabValue === 0 && (
                <CounsellorWiseEmailDetailsTable
                  ...
                  tabValue={tabValue}
                  tableHeader={templateWiseEmailDetailsTableHeader}
              ...
              {tabValue === 1 && (
                <CounsellorWiseSMSDetailsTable
                  ...
                  tableDetails={counsellorCommunicationDetails}
                  tabValue={tabValue}
                  tableHeader={templateWiseSMSDetailsTableHeader}
                  isTemplateManager={true}
                />
              )}
              {tabValue === 2 && (
                <CounsellorWiseWhatsappDetailsTable
                  ...
                  tableDetails={counsellorCommunicationDetails}
                  tabValue={tabValue}
                  tableHeader={templateWiseWhatsappDetailsTableHeader}
                  isTemplateManager={true}
                />
              )}
            </>
...
export default TemplateWiseDetailsTable;
